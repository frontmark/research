...
//hardcoded that terms can be at most 16 since we used bitsets for the binomial maps
//g++ main.cpp forces.cpp quadtree.cpp
//g++ main.cpp forces.cpp quadtree.cpp layout.cpp
